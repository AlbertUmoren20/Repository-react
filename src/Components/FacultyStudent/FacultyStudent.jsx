...
const fetchUrlMap = {
  FBMAS: "http://localhost:8080/student/getFbmasUpload",
  FAMSS: "http://localhost:8080/student/getFamssUpload",
  NURSING: "http://localhost:8080/student/getNursingUpload",
};
...
export default function FacultyStudent() {
  ...
  const fetchUrl =  `http://localhost:8080/student/getUpload/${abbreviation}`;
